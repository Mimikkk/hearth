...
import { asCommand, asNode, vec3 } from '../shadernode/ShaderNode.primitves.js';
import { LightNodeMap } from '../../nodes/lighting/LightsNodeMap.js';
import { Light } from '../../entities/lights/Light.js';
import { LightNode } from '../../nodes/lighting/LightNode.js';
...
export const lights = (lights: Light[] = []) => LightsNode.fromLights(lights);
export const lightsNode = asCommand(LightsNode);
