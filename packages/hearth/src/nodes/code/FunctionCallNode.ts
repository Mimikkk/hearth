...
import { asNode, asCommand } from '../shadernode/ShaderNode.primitves.js';
...
import { asNodes } from '../../nodes/shadernode/ShaderNode.as.js';
...
export const call = asCommand(CallCommand);
