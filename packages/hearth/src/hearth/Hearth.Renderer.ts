...
import { GPULoadOpType, GPUStoreOpType, GPUTextureViewDimensionType } from './constants.js';
import { RenderQueue, SortFn } from './core/RenderQueue.js';
...
export class HearthRenderer extends HearthComponent {
  ...
  async run(scene: Entity, camera: Camera): Promise<RenderContext> {
    ...
    this.hearth.occlusion.setSize(context, list.occlusionQueryCount);
