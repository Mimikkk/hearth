...
import { Blending, ColorSpace, Mapping, Side, TextureDataType, TextureFormat, ToneMapping } from '../constants.js';
...
import { BoxGeometry } from '../entities/geometries/BoxGeometry.js';
  ...
  _sceneToCubeUV(scene, near, far, cubeUVRenderTarget) {
    ...
    if (background) {
      if (background.isColor) {
        backgroundMaterial.color.from(background);
        scene.background = null;
        useSolidColor = true;
      }
    } else {
      backgroundMaterial.color.from(_clearColor);
      useSolidColor = true;
    }
