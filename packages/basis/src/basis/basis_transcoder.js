...
export async function makeBasis(Module = {}) {
  ...
  async function createWasm() {
    ...
    function instantiateArrayBuffer(receiver) {
      return WebAssembly.instantiate(new Uint8Array(wasmBinary), info).then(receiver, reason => {
