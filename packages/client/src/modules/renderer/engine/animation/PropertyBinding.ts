...
export class PropertyBinding {
  ...
  bind() {
    ...
    if (!targetObject) {
      console.warn('engine.PropertyBinding: No target node found for track: ' + this.path + '.');
      return;
    }
    ...
    if (objectName) {
      ...
      switch (objectName) {
        case 'materials':
          if (!targetObject.material) {
            console.error('engine.PropertyBinding: Can not bind to material as node does not have a material.', this);
            return;
          }

          if (!targetObject.material.materials) {
            console.error(
              'engine.PropertyBinding: Can not bind to material.materials as node.material does not have a materials array.',
              this,
            );
            return;
          }
        ...
        case 'bones':
          if (!targetObject.skeleton) {
            console.error('engine.PropertyBinding: Can not bind to bones as node does not have a skeleton.', this);
            return;
          }
        ...
        case 'map':
          ...
          if (!targetObject.material.map) {
            console.error(
              'engine.PropertyBinding: Can not bind to material.map as node.material does not have a map.',
              this,
            );
            return;
          }
        ...
        default:
          if (targetObject[objectName] === undefined) {
            console.error('engine.PropertyBinding: Can not bind to objectName of node undefined.', this);
            return;
          }
      ...
      if (objectIndex !== undefined) {
        if (targetObject[objectIndex] === undefined) {
          console.error(
            'engine.PropertyBinding: Trying to bind to objectIndex of objectName, but is undefined.',
            this,
            targetObject,
          );
          return;
    ...
    if (nodeProperty === undefined) {
      ...
      console.error(
        'engine.PropertyBinding: Trying to update property for track: ' +
          nodeName +
          '.' +
          propertyName +
          " but it wasn't found.",
    ...
    if (propertyIndex !== undefined) {
      ...
      if (propertyName === 'morphTargetInfluences') {
        ...
        if (!targetObject.geometry) {
          console.error(
            'engine.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.',
            this,
          );
          return;
        }
        ...
        if (!targetObject.geometry.morphAttributes) {
          console.error(
            'engine.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.morphAttributes.',
            this,
          );
          return;
        }
