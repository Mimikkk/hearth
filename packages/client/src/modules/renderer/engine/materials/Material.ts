...
import type { Plane } from '@modules/renderer/engine/math/Plane.js';
import { v4 } from 'uuid';
...
import type { PositionNode } from '@modules/renderer/engine/nodes/accessors/PositionNode.js';
...
export class Material {
  ...
  setValues(values?: MaterialParameters): void {
    ...
    const isVector3 = (v: any): v is Vec3 => v instanceof Vec3;
