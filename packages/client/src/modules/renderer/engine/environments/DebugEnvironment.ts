import { BoxGeometry, Mesh, MeshLambertMaterial, MeshStandardMaterial, PointLight, Scene, Side } from '../engine.js';
...
export class DebugEnvironment extends Scene {
  constructor() {
    ...
    const roomMaterial = new MeshStandardMaterial({ metalness: 0, side: Side.Back });
