...
class DRACOLoader {
  ...
  async _loadLibrary(url: string, responseType: FileLoaderResponse) {
  ...
  _initDecoder() {
    ...
    if (useJS) {
      librariesPending.push(this._loadLibrary(DracoDecoderCode, FileLoaderResponse.Text));
    } else {
      librariesPending.push(this._loadLibrary(DracoDecoderWrap, FileLoaderResponse.Text));
      librariesPending.push(this._loadLibrary(DracoDecoderWasm, FileLoaderResponse.Buffer));
    }
