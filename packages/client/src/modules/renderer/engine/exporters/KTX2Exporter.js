import { ColorSpace, DataTexture, Revision, TextureDataType, TextureFormat } from '../engine.js';
...
const ERROR_INPUT =
  'engine.KTX2Exporter: Supported inputs are DataTexture, Data3DTexture, or Renderer and WebGLRenderTarget.';
const ERROR_FORMAT = 'engine.KTX2Exporter: Supported formats are RGBAFormat, RGFormat, or RedFormat.';
const ERROR_TYPE =
  'engine.KTX2Exporter: Supported types are TextureDataType.Float, TextureDataType.HalfFloat, or TextureDataType.UnsignedByte."';
const ERROR_COLOR_SPACE =
  'engine.KTX2Exporter: Supported color spaces are ColorSpace.SRGB (TextureDataType.UnsignedByte only), ColorSpace.LinearSRGB, or ColorSpace.No.';
...
export class KTX2Exporter {
  parse(arg1, arg2) {
    ...
    container.keyValue['KTXwriter'] = `engine.js ${Revision}`;
