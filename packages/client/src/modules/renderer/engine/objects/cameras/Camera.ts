...
import type { PerspectiveCamera } from '@modules/renderer/engine/objects/cameras/PerspectiveCamera.js';
import type { OrthographicCamera } from '@modules/renderer/engine/objects/cameras/OrthographicCamera.js';
