...
export class PerlinNoise {
  noise(x: number, y: number, z: number): number {
    ...
    return lerp(
      ...
      lerp(
        v,
        lerp(u, grad(lut[AA], x, y, z), grad(lut[BA], xMinus1, y, z)),
        lerp(u, grad(lut[AB], x, yMinus1, z), grad(lut[BB], xMinus1, yMinus1, z)),
      ),
      lerp(
        v,
        lerp(u, grad(lut[AA + 1], x, y, zMinus1), grad(lut[BA + 1], xMinus1, y, zMinus1)),
        lerp(u, grad(lut[AB + 1], x, yMinus1, zMinus1), grad(lut[BB + 1], xMinus1, yMinus1, zMinus1)),
      ),
    );
  }
}
