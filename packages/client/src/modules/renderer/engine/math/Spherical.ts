...
export namespace Spherical {
  ...
  export const fromCartesian = (from: Const<Vector3>): Spherical => fromCartesian_(from, empty());
  export const fromCartesian_ = ({ x, y, z }: Const<Vector3>, into: Spherical): Spherical => {
  ...
  export const fillCartesian = (self: Spherical, from: Const<Vector3>): Spherical => fromCartesian_(from, self);
