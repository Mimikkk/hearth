...
export namespace Euler_ {
  ...
  export const fromMat = (matrix: Readonly<Mat4x4>, order: Order): Euler_ => fromMat_(matrix, order, empty());
  export const fromMat_ = (matrix: Readonly<Mat4x4>, order: Order, into: Euler_): Euler_ => {
    const m11 = matrix[0];
    const m12 = matrix[4];
    const m13 = matrix[8];
    const m21 = matrix[1];
  ...
  export const fillMat = (self: Euler_, matrix: Readonly<Mat4x4>): Euler_ => fromMat_(matrix, self.order, self);
