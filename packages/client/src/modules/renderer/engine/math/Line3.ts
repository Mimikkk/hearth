...
export namespace Line3 {
  ...
  export const fromEnds = (start: Const<Vec3>, end: Const<Vec3>): Line3 => fromEnds_(start, end, empty());
  export const fromEnds_ = (start: Const<Vec3>, end: Const<Vec3>, into: Line3): Line3 => {
    Vec3.clone_(start, into.start);
    Vec3.clone_(end, into.end);
    return into;
  };
  export const fillEnds = (self: Line3, start: Const<Vec3>, end: Const<Vec3>): Line3 => fromEnds_(start, end, self);
  ...
  export const distanceSq = ({ end, start }: Const<Line3>): number => Vec3.distanceSqTo(start, end);
  export const distance = ({ end, start }: Const<Line3>): number => Vec3.distanceTo(start, end);
  ...
  export const delta = (from: Const<Line3>): Vec3 => delta_(from, Vec3.empty());
  export const delta_ = ({ end, start }: Const<Line3>, into: Vec3): Vec3 => Vec3.sub_(end, start, into);
  ...
  export const closestAt = (self: Const<Line3>, vec: Const<Vec3>): number => {
  ...
  export const closestTo = (self: Const<Line3>, vec: Const<Vec3>): Vec3 => closestTo_(self, vec, Vec3.empty());
  export const closestTo_ = (self: Const<Line3>, vec: Const<Vec3>, into: Vec3): Vec3 =>
