  ...
  parse(data, path) {
    ...
    function buildBackgroundNode(node) {
      ...
      if (skyColor) {
        ...
        const skyMaterial = new MeshBasicMaterial({ fog: false, side: Side.Back, depthWrite: false, depthTest: false });
      ...
      if (geometry && geometry.attributes.position) {
        ...
        if (type === 'points') {
          ...
          if (geometry._solid !== undefined) {
            material.side = geometry._solid ? Side.Front : Side.Double;
          }
    ...
    function buildPixelTextureNode(node) {
      let texture;
      let wrapS = Wrapping.Repeat;
      let wrapT = Wrapping.Repeat;
      ...
      for (let i = 0, l = fields.length; i < l; i++) {
        ...
        switch (fieldName) {
          ...
          case 'repeatS':
            if (fieldValues[0] === false) wrapS = Wrapping.ClampToEdge;
            break;

          case 'repeatT':
            if (fieldValues[0] === false) wrapT = Wrapping.ClampToEdge;
            break;
