import { CompressedPixelFormat, CompressedTextureLoader } from '../../threejs/Three.js'; /*
...
function _parseV3(pvrDatas) {
  ...
  switch (pixelFormat) {
    case 0: // PVRTC 2bpp RGB
      bpp = 2;
      format = CompressedPixelFormat.RGB_PVRTC_2BPPV1;
      break;

    case 1: // PVRTC 2bpp RGBA
      bpp = 2;
      format = CompressedPixelFormat.RGBA_PVRTC_2BPPV1;
      break;

    case 2: // PVRTC 4bpp RGB
      bpp = 4;
      format = CompressedPixelFormat.RGB_PVRTC_4BPPV1;
      break;

    case 3: // PVRTC 4bpp RGBA
      bpp = 4;
      format = CompressedPixelFormat.RGBA_PVRTC_4BPPV1;
      break;
...
function _parseV2(pvrDatas) {
  ...
  if (formatFlags === PVRTC_4) {
    format = _hasAlpha ? CompressedPixelFormat.RGBA_PVRTC_4BPPV1 : CompressedPixelFormat.RGB_PVRTC_4BPPV1;
    bpp = 4;
  } else if (formatFlags === PVRTC_2) {
    format = _hasAlpha ? CompressedPixelFormat.RGBA_PVRTC_2BPPV1 : CompressedPixelFormat.RGB_PVRTC_2BPPV1;
    bpp = 2;
  } else {
