...
const NON_ALPHA_CHANNEL_FORMATS = [
  CompressedPixelFormat.RGB_S3TC_DXT1,
  CompressedPixelFormat.RGB_PVRTC_4BPPV1,
  CompressedPixelFormat.RGB_PVRTC_2BPPV1,
  CompressedPixelFormat.RGB_ETC1,
  CompressedPixelFormat.RGB_ETC2,
];
...
class MaterialBuilder {
  ...
  build(data, geometry /*, onProgress, onError */) {
    ...
    for (let i = 0; i < data.metadata.materialCount; i++) {
      ...
      params.specular = new Color().setRGB(...material.specular, ColorSpace.SRGB);
      params.shininess = material.shininess;
      params.emissive = new Color().setRGB(...material.ambient, ColorSpace.SRGB);
      ...
      params.blending = Blending.Custom;
      params.blendSrc = BlendingFactor.SrcAlpha;
      params.blendDst = BlendingFactor.OneMinusSrcAlpha;
      params.blendSrcAlpha = BlendingFactor.SrcAlpha;
      params.blendDstAlpha = BlendingFactor.DstAlpha;

      // side

      if (data.metadata.format === 'pmx' && (material.flag & 0x1) === 1) {
        params.side = Side.Double;
      } else {
        params.side = params.opacity === 1.0 ? Side.Front : Side.Double;
      }
      ...
      if (data.metadata.format === 'pmd') {
        ...
        if (material.fileName) {
          ...
          if (fileNames.length > 1) {
            ...
            params.matcapCombine = extension === '.sph' ? Operation.Multiply : Operation.Add;
          }
        }
        ...
        if (material.envTextureIndex !== -1 && (material.envFlag === 1 || material.envFlag == 2)) {
          ...
          params.matcapCombine = material.envFlag === 1 ? Operation.Multiply : Operation.Add;
        }
    ...
    const texture = loader.load(
      ...
      function (t) {
        ...
        if (params.isToonTexture === true) {
          ...
          t.magFilter = Filter.Nearest;
          t.minFilter = Filter.Nearest;
        }

        t.flipY = false;
        t.wrapS = Wrapping.Repeat;
        t.wrapT = Wrapping.Repeat;
...
class MMDToonMaterial extends ShaderMaterial {
  constructor(parameters) {
    ...
    this._matcapCombine = Operation.Add;
