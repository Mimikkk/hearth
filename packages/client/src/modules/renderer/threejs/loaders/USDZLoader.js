  ...
  parse(buffer) {
      ...
      if (data !== undefined) {
        if ('def Shader "PreviewSurface"' in data) {
          ...
          if ('color3f inputs:diffuseColor.connect' in surface) {
            ...
            material.map.colorSpace = ColorSpace.SRGB;
          ...
          if ('color3f inputs:emissiveColor.connect' in surface) {
            ...
            material.emissiveMap.colorSpace = ColorSpace.SRGB;
          ...
          if ('normal3f inputs:normal.connect' in surface) {
            ...
            material.normalMap.colorSpace = ColorSpace.No;
          ...
          if ('float inputs:roughness.connect' in surface) {
            ...
            material.roughnessMap.colorSpace = ColorSpace.No;
          ...
          if ('float inputs:metallic.connect' in surface) {
            ...
            material.metalnessMap.colorSpace = ColorSpace.No;
          ...
          if ('float inputs:clearcoat.connect' in surface) {
            ...
            material.clearcoatMap.colorSpace = ColorSpace.No;
          ...
          if ('float inputs:clearcoatRoughness.connect' in surface) {
            ...
            material.clearcoatRoughnessMap.colorSpace = ColorSpace.No;
          ...
          if ('float inputs:occlusion.connect' in surface) {
            ...
            material.aoMap.colorSpace = ColorSpace.No;
    ...
    function buildTexture(data) {
      if ('asset inputs:file' in data) {
        ...
        const map = {
          '"clamp"': Wrapping.ClampToEdge,
          '"mirror"': Wrapping.MirroredRepeat,
          '"repeat"': Wrapping.Repeat,
        };
