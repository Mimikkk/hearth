import { CompressedPixelFormat, CompressedTextureLoader, TextureFormat } from '../../threejs/Three.js';
...
class DDSLoader extends CompressedTextureLoader {
  ...
  parse(buffer, loadMipmaps) {
    ...
    switch (fourCC) {
      case FOURCC_DXT1:
        blockBytes = 8;
        dds.format = CompressedPixelFormat.RGB_S3TC_DXT1;
        break;

      case FOURCC_DXT3:
        blockBytes = 16;
        dds.format = CompressedPixelFormat.RGBA_S3TC_DXT3;
        break;

      case FOURCC_DXT5:
        blockBytes = 16;
        dds.format = CompressedPixelFormat.RGBA_S3TC_DXT5;
        break;

      case FOURCC_ETC1:
        blockBytes = 8;
        dds.format = CompressedPixelFormat.RGB_ETC1;
        break;
      ...
      case FOURCC_DX10:
        ...
        switch (dxgiFormat) {
          case DXGI_FORMAT_BC6H_SF16: {
            blockBytes = 16;
            dds.format = CompressedPixelFormat.RGB_BPTC_SIGNED;
            break;
          }

          case DXGI_FORMAT_BC6H_UF16: {
            blockBytes = 16;
            dds.format = CompressedPixelFormat.RGB_BPTC_UNSIGNED;
            break;
          }
