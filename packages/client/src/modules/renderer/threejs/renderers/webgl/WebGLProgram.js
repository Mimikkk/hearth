...
function getEncodingComponents(colorSpace) {
  ...
  if (workingPrimaries === encodingPrimaries) {
    gamutMapping = '';
  } else if (workingPrimaries === ColorPrimary.P3 && encodingPrimaries === ColorPrimary.Rec709) {
    gamutMapping = 'LinearDisplayP3ToLinearSRGB';
  } else if (workingPrimaries === ColorPrimary.Rec709 && encodingPrimaries === ColorPrimary.P3) {
...
function getToneMappingFunction(functionName, toneMapping) {
  ...
  switch (toneMapping) {
    case ToneMapping.LinearTone:
      toneMappingName = 'Linear';
      break;

    case ToneMapping.ReinhardTone:
      toneMappingName = 'Reinhard';
      break;

    case ToneMapping.CineonTone:
      toneMappingName = 'OptimizedCineon';
      break;

    case ToneMapping.ACESFilmicTone:
      toneMappingName = 'ACESFilmic';
      break;

    case ToneMapping.AgXTone:
      toneMappingName = 'AgX';
      break;

    case ToneMapping.NeutralTone:
      toneMappingName = 'Neutral';
      break;

    case ToneMapping.CustomTone:
...
function WebGLProgram(renderer, cacheKey, parameters, bindingStates) {
  ...
  if (parameters.isRawShaderMaterial !== true) {
    ...
    prefixFragment =
      [
        '#define varying in',
        parameters.glslVersion === GLSLVersion.GLSL3 ? '' : 'layout(location = 0) out highp vec4 pc_fragColor;',
        parameters.glslVersion === GLSLVersion.GLSL3 ? '' : '#define gl_FragColor pc_fragColor',
