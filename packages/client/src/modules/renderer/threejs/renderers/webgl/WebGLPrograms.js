...
function WebGLPrograms(renderer, cubemaps, cubeuvmaps, extensions, capabilities, bindingStates, clipping) {
  ...
  function getParameters(material, lights, shadows, scene, object) {
    ...
    const envMapCubeUVHeight = !!envMap && envMap.mapping === Mapping.CubeUVReflection ? envMap.image.height : null;
    ...
    const parameters = {
      ...
      normalMapObjectSpace: HAS_NORMALMAP && material.normalMapType === NormalMapType.ObjectSpace,
      normalMapTangentSpace: HAS_NORMALMAP && material.normalMapType === NormalMapType.TangentSpace,
      ...
      opaque:
        material.transparent === false && material.blending === Blending.Normal && material.alphaToCoverage === false,
      ...
      decodeVideoTexture:
        ...
        ColorManagement.getTransfer(material.map.colorSpace) === TransferFunction.SRGB,
      ...
      extensionClipCullDistance:
        HAS_EXTENSIONS && material.extensions.clipCullDistance === true && extensions.has('WEBGL_clip_cull_distance'),
      extensionMultiDraw:
        HAS_EXTENSIONS && material.extensions.multiDraw === true && extensions.has('WEBGL_multi_draw'),
