...
function WebGLBackground(renderer, cubemaps, cubeuvmaps, state, objects, alpha, premultipliedAlpha) {
  ...
  function render(renderList, scene) {
    ...
    if (background && (background.isCubeTexture || background.mapping === Mapping.CubeUVReflection)) {
      ...
      boxMesh.material.toneMapped = ColorManagement.getTransfer(background.colorSpace) !== TransferFunction.SRGB;
      ...
      planeMesh.material.toneMapped = ColorManagement.getTransfer(background.colorSpace) !== TransferFunction.SRGB;
