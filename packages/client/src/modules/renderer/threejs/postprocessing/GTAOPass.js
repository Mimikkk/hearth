...
class GTAOPass extends Pass {
  ...
  setGBuffer(depthTexture, normalTexture) {
    if (depthTexture !== undefined) {
      ...
      this.depthTexture.format = TextureFormat.DepthStencil;
      this.depthTexture.type = TextureDataType.UnsignedInt248;
  ...
  render(renderer, writeBuffer, readBuffer /*, deltaTime, maskActive */) {
    ...
    switch (this.output) {
      ...
      case GTAOPass.OUTPUT.Diffuse:
        ...
        this.copyMaterial.blending = Blending.None;
  ...
  generateNoise(size = 64) {
    ...
    const noiseTexture = new DataTexture(data, size, size, TextureFormat.RGBA, TextureDataType.UnsignedByte);
