import { GLSLNodeParser, MathNode, NodeBuilder, UniformNode, vectorComponents } from '../../../nodes/Nodes.js';
...
import { DataTexture, TextureDataType, TextureFormat } from '../../../../threejs/Three.js';
...
${flowData.code}
  ...
  setupPBO(storageBufferNode) {
    ...
    if (attribute.pbo === undefined) {
      ...
      const pboTexture = new DataTexture(attribute.array, width, height, format, TextureDataType.Float);
  ...
  getTypeFromAttribute(attribute) {
    ...
    if (/^[iu]/.test(nodeType) && attribute.gpuType !== TextureDataType.Int) {
