import { ColorSpace, DepthComparison, Filter, TextureDataType, Wrapping } from '../../../../threejs/Three.js';
...
class WebGLTextureUtils {
  ...
  _init(gl) {
    ...
    compareToGL = {
      ...
      [DepthComparison.LessEqual]: gl.LEQUAL,
      [DepthComparison.Equal]: gl.EQUAL,
      [DepthComparison.GreaterEqual]: gl.GEQUAL,
  ...
  getInternalFormat(internalFormatName, glFormat, glType, colorSpace, forceLinearTransfer = false) {
    ...
    if (glFormat === gl.RGBA) {
      ...
      if (glType === gl.UNSIGNED_BYTE)
        internalFormat = colorSpace === ColorSpace.SRGB && forceLinearTransfer === false ? gl.SRGB8_ALPHA8 : gl.RGBA8;
  ...
  setTextureParameters(textureType, texture) {
    ...
    const minFilter =
      !texture.isVideoTexture && texture.minFilter === Filter.Linear ? Filter.LinearMipmapLinear : texture.minFilter;
