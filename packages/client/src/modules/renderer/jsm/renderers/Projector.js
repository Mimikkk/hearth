import { Box3, Color, Frustum, Matrix3, Matrix4, Side, Vector2, Vector3, Vector4 } from '../../threejs/Three.js';
  ...
  constructor() {
    ...
    function RenderList() {
      ...
      function pushTriangle(a, b, c, material) {
        ...
        if (material.side === Side.Double || checkBackfaceCulling(v1, v2, v3) === true) {
