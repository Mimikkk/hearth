...
class RenderPixelatedPass extends Pass {
  constructor(pixelSize, scene, camera, options = {}) {
    ...
    this.beautyRenderTarget.texture.minFilter = Filter.Nearest;
    this.beautyRenderTarget.texture.magFilter = Filter.Nearest;
    this.beautyRenderTarget.texture.type = TextureDataType.HalfFloat;
    this.beautyRenderTarget.depthTexture = new DepthTexture();

    this.normalRenderTarget = new WebGLRenderTarget();
    this.normalRenderTarget.texture.minFilter = Filter.Nearest;
    this.normalRenderTarget.texture.magFilter = Filter.Nearest;
    this.normalRenderTarget.texture.type = TextureDataType.HalfFloat;
  }
