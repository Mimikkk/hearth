...
class SAOPass extends Pass {
  constructor(scene, camera, resolution = new Vector2(256, 256)) {
    ...
    this.normalMaterial.blending = Blending.None;
    ...
    this.saoMaterial.blending = Blending.None;
    ...
    this.vBlurMaterial.blending = Blending.None;
    ...
    this.hBlurMaterial.blending = Blending.None;
    ...
    this.materialCopy.blending = Blending.Custom;
    this.materialCopy.blendSrc = BlendingFactor.DstColor;
    this.materialCopy.blendDst = BlendingFactor.Zero;
    this.materialCopy.blendEquation = BlendingEquation.Add;
    this.materialCopy.blendSrcAlpha = BlendingFactor.DstAlpha;
    this.materialCopy.blendDstAlpha = BlendingFactor.Zero;
    this.materialCopy.blendEquationAlpha = BlendingEquation.Add;
  ...
  render(renderer, writeBuffer, readBuffer /*, deltaTime, maskActive*/) {
    ...
    if (this.renderToScreen) {
      this.materialCopy.blending = Blending.None;
    ...
    if (this.params.output === SAOPass.OUTPUT.Default) {
      outputMaterial.blending = Blending.Custom;
    } else {
      outputMaterial.blending = Blending.None;
    }
